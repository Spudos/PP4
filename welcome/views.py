...
def user_account(request):
    ...
    user_past_bookings = user_bookings.filter(
        appointment__date_time__lt=date.today()).order_by(
        "appointment__date_time")
    user_future_bookings = user_bookings.filter(
        appointment__date_time__gt=date.today()).order_by(
        "appointment__date_time")
